...
class LaminaProcesador_IV extends JPanel{
	public LaminaProcesador_IV() {
		...
		//-------------CheckBox-----------------	
		JCheckBoxMenuItem negrita=new JCheckBoxMenuItem("Negrita",new ImageIcon("bin/main.java.graficos/esfera.jpg"));
		JCheckBoxMenuItem cursiva=new JCheckBoxMenuItem("Cursiva",new ImageIcon("bin/main.java.graficos/esfera.jpg"));
		negrita.addActionListener(new StyledEditorKit.BoldAction());
		cursiva.addActionListener(new StyledEditorKit.ItalicAction());
		estilo.add(negrita);estilo.add(cursiva);
		//configura_menu("Negrita","estilo","",Font.BOLD,1,"bin/main.java.graficos/esfera.jpg");
		//configura_menu("Cursiva","estilo","",Font.ITALIC,1,"bin/main.java.graficos/esfera.jpg")
		//-------------Radio Button----------------
