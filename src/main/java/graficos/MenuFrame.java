...
class MenuLamina extends JPanel{
	public MenuLamina() {
		...
		JMenuItem cortar=new JMenuItem("Cortar",new ImageIcon("bin/main.java.graficos/esfera.jpg"));
		JMenuItem copiar=new JMenuItem("Copiar",new ImageIcon("bin/main.java.graficos/esfera.jpg"));
		copiar.setHorizontalTextPosition(SwingConstants.LEFT);//cambia icono de posicion
		JMenuItem pegar=new JMenuItem("Pegar",new ImageIcon("bin/main.java.graficos/esfera.jpg"));
