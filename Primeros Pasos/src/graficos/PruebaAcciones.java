...
class PanelAccion extends JPanel{
	public PanelAccion() {
		...
		AccionColor accionAmarillo=new AccionColor("Amarillo", new ImageIcon("src/graficos/esfera.jpg"), Color.YELLOW);
		AccionColor accionAzul=new AccionColor("Azul", new ImageIcon("src/graficos/esfera.jpg"), Color.BLUE);
		AccionColor accionRojo=new AccionColor("Rojo", new ImageIcon("src/graficos/esfera.jpg"), Color.RED);
